...
(function($, window, document, undefined) {
	...
	function CubePortfolio(obj, options, callback) {
		...
		// wait to load all img and then go further
		...
		loadImages: function(elems, callback) {
			...
			requestAnimationFrame(function() {
				var imgs = elems.find('img').map(function(index, el) {
					// don't wait for img that have a width & height defined
...
jQuery.fn.cubeportfolio.options = {
	 ...
	 *          - fadeIn (the plugin will fully preload the img before displaying the items with a fadeIn effect)
	 *          - fadeInToTop (the plugin will fully preload the img before displaying the items with a fadeIn effect from bottom to top)
	 *          - sequentially (the plugin will fully preload the img before displaying the items with a sequentially effect)
	 *          - bottomToTop (the plugin will fully preload the img before displaying the items with an animation from bottom to top)
	 */
	displayType: 'fadeIn',
...
(function($, window, document, undefined) {
	...
	var options = {
		...
		threshold: 400, // loads img 150px before they're visible
	};
